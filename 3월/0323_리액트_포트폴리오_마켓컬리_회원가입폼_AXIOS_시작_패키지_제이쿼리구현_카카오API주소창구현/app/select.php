<?
    ...
    // http://cshong123.dothome.co.kr/signup_db/select.php
    // CORS
    ...
    while( $row = mysqli_fetch_array($result) ){
        ...
        // 이스케이프(ESCAPED) 문자 유니코드 문자 사용 안함  JSON_UNESCAPED_UNICODE
