...
public class J01_화면입력 {
    ...
    public static void main(String[] args) {
        ...
        // 1. 문자열 입력을 받을때 외부 클래스인 Scanner를 임포트 해서 
        // 생성자를 생성하여 사용한다.
        // 문단을 입력 받는다 즉 엔터를 만나면 입력 받는다. 즉 문단 파라그래프(pharagraphe)
        ...
        System.out.println("입력 된 실수는 : " + num_d);


        // 5. 글자단위 문자(1글자) 입력 : next().글자 단위로 (인덱스 번호); 
        ...
        // System.out.println("입력된 글자는(첫번째) = " + ch1 );
        // System.out.println("입력된 글자는(첫번째) = " + ch2 );
