...
export default function WrapComponent() {
    ...
    return (
        <div id='wrap'>
                <TopModalComponent/>
                <HeaderComponent />
                <SignUpComponent  addressOpenPosstcode={addressOpenPosstcode}  주소1={state.주소1}  주소2={state.주소2} timer={state} timerCounterfn={timerCounterfn} />
                <FooterComponent/>
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <div className="input-box box1">
                                                    <input type="text" name='modal_ddr1' id='modalAddr1' placeholder='주소1' value={state.주소1} />
