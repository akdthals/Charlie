...
export default function SignUpComponent({회원가입, timer, timerCounterfn, addressOpenPosstcode, 주소1, 주소2 }) {
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <div>
                                                ...
                                                <div className="center-box">
                                                    <button 
                                                        className={`addr-search-btn${state.isAddress?' on':'on'}`}  
                                                        type='button'
                                                        onClick={onClickOpenAddressApi}
                                                    >주소검색</button>
                                                    <input type='text' className={`${state.isAddress?'on':'on'}`} name='user_address1' id='userAddress1' placeholder='검색   주소1' value={주소1} />
                                                    <input type='text' className={`${state.isAddress?'on':''}`} name='user_address2' id='userAddress2' placeholder='나머지 주소2' value={주소2}  />
                                                    <h5>샛별배송</h5>
