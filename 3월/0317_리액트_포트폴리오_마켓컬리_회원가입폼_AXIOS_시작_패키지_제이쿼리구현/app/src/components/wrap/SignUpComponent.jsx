    ...
    const onClickUserIdOk=(e)=>{
        ...
        if( regExp2.test(value)===false || regExp3.test(value)===true || regExp4.test(value)===false || regExp5.test(value)===true){
            ...
            setState({
                ...state,
                isConfirmModal: true,
                isConfirmMsg:'6자 이상 16자 이하의 영문 혹은 영문과 숫자를 조합',
            })
        } 
        else {
            // 아이디 중복검사 실시
...
SignUpComponent.defaultProps = {
    회원가입: {
        ...
        isConfirmModal:true,
        isConfirmMsg:'사용가능한 아이디입니다. 아이디는 16자이하로 사용가능합니다',
