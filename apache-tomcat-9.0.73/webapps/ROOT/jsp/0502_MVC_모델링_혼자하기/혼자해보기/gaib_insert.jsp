...
<body>
    ...
    <div id="wrap">
        ...
        <form name="gaib_form" id="gaibForm" method="post" action="gaib-insert_action.jsp">
            <ul>
                <li><input type="text" name="user_id" id="userId" placeholder="아이디를 입력하세요"></li>
                <li><input type="text" name="user_pw" id="userPw" placeholder="비밀번호를 입력하세여"></li>
                <li><input type="text" name="user_name" id="userName" placeholder="이름을 입력하세요"></li>
                <li><input type="text" name="user_hp" id="userHp" placeholder="휴대폰번호를 입력하세요"></li>
