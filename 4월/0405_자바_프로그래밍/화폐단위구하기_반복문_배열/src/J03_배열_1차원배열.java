...
/* 
        ...
        배열의 저장공간은 배열 인덱스 번호로 시작이 0부터 ~ 순서를 갖는다. 
        처음 생성(생성자방식 new )할때 배열의 크기를 정해야하며 
        한번 크기를 정하면 변경할 수 없다.
        
        **
        배열의 선언 방법 
        1. 데이터 목록으로 배열을 생성하기 
           자료형 [] 변수명 = {대이터1, 데이터2, 데이터3 ...}
    */
...
public class J03_배열_1차원배열 {
    ...
    public static void main(String[] args) {
        ...
        arr[0] = 200; // 10 첫번째 배열 값 10을 200으로 변경한다.
        arr[1] = 300; // 10 첫번째 배열 값 20을 300으로 변경한다.
        arr[2] = 400; // 10 첫번째 배열 값 30을 400으로 변경한다. 
        arr[3] = 500; // 10 첫번째 배열 값 40을 500으로 변경한다.
        arr[4] = 600; // 10 첫번째 배열 값 50을 600으로 변경한다.

        System.out.println();
        System.out.println("================= 변경된 배열 출력 인덱스 번호 반복문 활용 ================");
        System.out.println();
        ...
        int[] arr4 = new int[3]; // 배열 저장 공간 장소 3개(배열원소 3개)
        ...
        System.out.println();
        System.out.println("================= 배열 입력받은 데이터 출력 하기 ================");
        System.out.println();
