<?
    ...
    // http://cshong123.dothome.co.kr/signup_db/form_data_insert.php
    ...
    $user_user_hp   = $_POST['user_user_hp'];
    ...
    $sql = "INSERT INTO signup_table(id, pw, irum, email, hp, addr, gender, birth, chooga, service, gaib_date)
            VALUES('$user_id', '$user_pw', '$user_name', '$user_email', '$user_user_hp', '$user_addr', '$user_gender', '$user_birth', ' $user_add_input', '$user_service ', '$user_gaib_date')";
