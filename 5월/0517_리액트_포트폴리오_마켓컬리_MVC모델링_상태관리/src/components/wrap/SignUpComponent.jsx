...
export default function SignUpComponent({회원가입, timer, timerCounterfn, mapAddressFn}) {
    ...
    const onSubmitSignupEvent=(e)=>{
        ...
        if(state.아이디===''){
            ...
            //     url:'http://localhost:8080/jsp/0512_MVC_모델링_프로젝트_AJAX_DTO_DAO/쇼핑몰고객관리/kurly_user_signup_action.jsp',
            //     // url:'http://localhost:8080/jsp/0512_MVC_모델링_프로젝트_AJAX_DTO_DAO/쇼핑몰고객관리/kurly_user_signup_action_test_parameter.jsp',
            //     // url:'http://localhost:8080/jsp/0512_MVC_모델링_프로젝트_AJAX_DTO_DAO/쇼핑몰고객관리/kurly_user_signup_action_test_useBean.jsp',
            //     type:'POST',
            //     data: formData,
            //     success(res){
            //         console.log('AJAX 성공!');
            ...
            .then((res)=>res.json())
            .then((res)=>{
                console.log('FETCH 가져오기 성공');
                console.log(res);
            });


            // [2] AXIOS() GET 구현 => 1. url packege.json 에서 proxy 설정
            ...
            // [1] AXIOS() POST 구현 => 1. url packege.json 에서 proxy 설정
            //                     2. data : {} , new URLSearchParams(); 파라미터 속성 만들기
            // 프로미스 반드시 ES6 사용 화살표 함수 이용
            // async = await
            // AXIOS()
            // FETCH() 
