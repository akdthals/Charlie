...
export default function Section3SlideComponent ({상품, n, setViewProduct}) {
    ...
    <a onClick={onClickNext} href="!#" className='left-arrorw-btn'><img src="./images/intro/icon_left_arrow_white.svg" alt="" /></a>
    <a onClick={onClickPrev} href="!#" className='right-arrorw-btn'><img src="./images/intro/icon_left_arrow_white.svg" alt="" /></a>
